 ...
 const selectedDay = (val: any) => {
  ...
  return (
    ...
    <div className='popupbox'>
      ...
      <TextField id="outlined-basic" label="Food item name" variant="outlined" color="primary" />
      <TextField id="outlined-basic" label="Food item amount (in gms)" variant="outlined" color="primary" />
